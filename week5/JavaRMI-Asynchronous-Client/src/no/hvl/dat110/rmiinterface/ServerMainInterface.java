...
public interface ServerMainInterface extends Remote {
	 ...
	 */
	public void registerClientCallbackObject(ClientCallbackInterface clientcallbackobj)
	throws RemoteException;

	public void doOperation(int a, int b)
	throws RemoteException;    // The add method

	public void shutdown()
	throws RemoteException;                    // this method is invoked remotely by client to shut the server down
